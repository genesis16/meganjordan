...
include 'qodef-instagram-helper.php';

/**
 * Class QodefInstagramApi
 */
class QodefInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var QodefInstagramApi instance of current class
	 */
	private static $instance;

	/**
	 * Helper object
	 * @var QodefInstagramHelper
	 */
	private $helper;

	const CODE_OPTION_NAME = 'qodef_instagram_code';
	const USER_ID_OPTION_NAME = 'qodef_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'qodef_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'qodef_instagram_code_redirect_uri';
	...
	private function __construct() {
		...
		$this->helper       = new QodefInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see QodefInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see QodefInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see QodefInstagramApi::getAccessToken()
	 */
