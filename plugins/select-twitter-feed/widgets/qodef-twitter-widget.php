...
class QodefTwitterWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		print moments_qodef_get_module_part( $args['after_widget'] );
	}
}
