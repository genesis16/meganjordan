...
if ( ! class_exists( 'MomentsCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class MomentsCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'moments-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'moments_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	MomentsCoreDashboardRestAPI::get_instance();
}