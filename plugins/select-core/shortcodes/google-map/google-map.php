...
namespace MomentsQodef\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface {
			...
			array(
				...
				'params'                  => array(
					...
					array(
						...
						'value'       => array(
							esc_html__( 'No', 'select-core' )  => 'false',
							esc_html__( 'Yes', 'select-core' ) => 'true'
						),
						'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = select_core_get_shortcode_template_part( 'templates/google-map-template', 'google-map', '', $params );
