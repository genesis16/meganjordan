<div class="qodef-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo moments_qodef_get_inline_attrs($elements_holder_item_data); ?> <?php echo moments_qodef_get_inline_style($elements_holder_item_style); ?>>
	<div class="qodef-elements-holder-item-inner">
		<div class="qodef-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo moments_qodef_get_inline_style($elements_holder_item_content_style); ?>>
			<?php if(count($elements_holder_item_content_responsive) > 0){ ?>
			<style type="text/css" data-type="qodef-elements-custom-padding" scoped>
                <?php if(!empty($elements_holder_item_content_responsive['item_padding_1280_1600'])){ ?>
                @media only screen and (min-width: 1280px) and (max-width: 1600px) {
                    .qodef-elements-holder-item-content.<?php echo esc_attr($elements_holder_item_content_class); ?> {
