...
function genesis_sample_enqueue_scripts_styles() {
	...
	if ( file_exists( get_stylesheet_directory() . '/dist/js/scripts.js' ) ) {
		wp_enqueue_script(
...
add_action( 'genesis_meta', 'genesis_sample_load_stylesheet' );
/**
 * Load the primary stylesheet.
 *
 * @since 1.3.3
 */
function genesis_sample_load_stylesheet() {

	if ( file_exists( get_stylesheet_directory() . '/dist/css/style.css' ) ) {
		wp_enqueue_style(
			genesis_get_theme_handle(),
