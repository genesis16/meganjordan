...
add_action('after_setup_theme', 'moments_qodef_admin_map_init', 0);

function moments_qodef_admin_map_init() {

    do_action('moments_qodef_before_options_map');
    ...
    do_action('moments_qodef_options_map');

    do_action('moments_qodef_after_options_map');
