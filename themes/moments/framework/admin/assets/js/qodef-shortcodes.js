            ...
            menu: [
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[qodef_blockquote text="' + e.data.text + '" title_tag="' + e.data.title_tag + '" width="' + e.data.width + '"]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[qodef_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '"]' + e.data.letter + '[/qodef_dropcaps]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[qodef_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '"]' + e.data.text + '[/qodef_highlight]');
                            }
                        });
                    }
                },
                        ...
                        ed.windowManager.open({
                            ...
                            body: [
                                ...
                                },
                                {
                                    ...
                                    label: 'Size',
                                    'values': [
                                        {text: 'Tiny', value: 'qodef-icon-tiny'},
                                        {text: 'Small', value: 'qodef-icon-small'},
                                        {text: 'Medium', value: 'qodef-icon-medium'},
                                        {text: 'Large', value: 'qodef-icon-large'},
                                        {text: 'Very Large', value: 'qodef-icon-huge'}
                                    ]
                                },
                                {
                                    type: 'textbox',
                ...
                },
                {
                    text: 'Ordered List',
                    onclick: function () {
                        ed.insertContent('[qodef_list_ordered]<ol><li>Lorem Ipsum</li><li>Lorem Ipsum</li><li>Lorem Ipsum</li></ol>[/qodef_list_ordered');
                    }
                },
                {
                    text: 'Unordered List',
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[qodef_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '" font_weight="' + e.data.font_weight + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/qodef_unordered_list]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[qodef_separator class_name="' + e.data.class_name + '" type="' + e.data.type + '" position="' + e.data.position + '" color="' + e.data.color + '" border_style="' + e.data.border_style + '" width="' + e.data.width + '" thickness="' + e.data.thickness + '" top_margin="' + e.data.top_margin + '" bottom_margin="' + e.data.bottom_margin + '"]');
                            }
                        });
                    }
                },
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ...
                                ed.insertContent('[qodef_icon_list_item icon_pack="' + e.data.icon_pack + '" ' + icon_pack_prefix + '="' + e.data.icon + '" icon_size="' + e.data.icon_size + '" icon_color="' + e.data.icon_color + '" title="' + e.data.title + '" title_color="' + e.data.title_color + '" title_size="' + e.data.title_size + '"]');
                            }
                        });
                    }
                },
                            ...
                            body: [
                                {
                                    ...
                                    'values': [
                                        ...
                                        {text: 'Extra Large', value: 'huge'},
                                        {text: 'Extra Large Full Width', value: 'huge-full-width'}
                                    ]
                                },
                                {
                                    type: 'listbox',
