<?php
if ( ! function_exists( 'moments_qodef_init_google_fonts_array' ) ) {
    function moments_qodef_init_google_fonts_array()
    {

        global $moments_qodef_fonts_array;
        $theme_name_fonts_json = '
        {
         ...
         "items": [
          ...
          },
          {
           ...
           "lastModified": "2016-05-31",
           "files": {
            "regular": "http://fonts.gstatic.com/s/bitter/v8/w_BNdJvVZDRmqy5aSfB2kQ.ttf",
            "italic": "http://fonts.gstatic.com/s/bitter/v8/TC0FZEVzXQIGgzmRfKPZbA.ttf",
            "700": "http://fonts.gstatic.com/s/bitter/v8/4dUtr_4BvHuoRU35suyOAg.ttf"
           }
          },
          {
           "kind": "webfonts#webfont",
        ...
        $theme_name_fonts_decoded = json_decode($theme_name_fonts_json, true);
        $moments_qodef_fonts_array = $theme_name_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'moments_qodef_init_google_fonts_array');
}