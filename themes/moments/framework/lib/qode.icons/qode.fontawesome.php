...
class MomentsQodefIconsFontAwesome implements iMomentsQodefIconCollection {
	...
	function __construct( $title_label = "", $param = "" ) {
		...
		$this->styleUrl = QODE_ASSETS_ROOT . "/css/font-awesome/css/font-awesome.min.css";
	}
	...
	public function render( $icon, $params = array() ) {
		...
		$html .= '<i class="qodef-icon-font-awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
