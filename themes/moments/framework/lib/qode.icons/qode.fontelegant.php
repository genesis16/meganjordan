...
class MomentsQodefIconsFontElegant implements iMomentsQodefIconCollection {
	...
	function __construct( $title_label = "", $param = "" ) {
		...
		$this->styleUrl = QODE_ASSETS_ROOT . "/css/elegant-icons/style.min.css";
	}
	...
	public function render( $icon, $params = array() ) {
		...
		$html .= '<span aria-hidden="true" class="qodef-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
