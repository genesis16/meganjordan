...
if (!function_exists('moments_qodef_get_footer_classes')) {
	/**
	 ...
	 * @return string|void
	 */
	function moments_qodef_get_footer_classes($page_id) {

		$footer_classes                     = '';
		$footer_classes_array               = array();

		//is uncovering footer option set in theme options?
		if(moments_qodef_options()->getOptionValue('uncovering_footer') == 'yes') {
...
if(!function_exists('moments_qodef_get_footer_top_border')) {
	/**
...
if(!function_exists('moments_qodef_get_footer_bottom_border')) {
	/**
...
if(!function_exists('moments_qodef_get_footer_bottom_bottom_border')) {
	/**
...
if (!function_exists('moments_qodef_footer_top_classes')) {
	/**
	 * Return classes for footer top
	 *
	 * @return string
	 */
	function moments_qodef_footer_top_classes() {

		$footer_top_classes = array();

		if(moments_qodef_options()->getOptionValue('footer_in_grid') != 'yes') {
			$footer_top_classes[] = 'qodef-footer-top-full';
		}

		//footer aligment
		if(moments_qodef_options()->getOptionValue('footer_top_columns_alignment') != '') {
			$footer_top_classes[] = 'qodef-footer-top-aligment-'.moments_qodef_options()->getOptionValue('footer_top_columns_alignment');
		}
