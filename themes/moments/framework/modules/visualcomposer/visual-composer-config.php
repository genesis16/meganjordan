...
if ( ! function_exists( 'moments_qodef_configure_visual_composer' ) ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function moments_qodef_configure_visual_composer() {
	...
	add_action( 'vc_after_init', 'moments_qodef_configure_visual_composer' );

}


if ( ! function_exists( 'moments_qodef_configure_visual_composer_grid_elemets' ) ) {
	...
	function moments_qodef_configure_visual_composer_grid_elemets() {
	...
	add_action( 'vc_after_init', 'moments_qodef_configure_visual_composer_grid_elemets' );
}


if ( ! function_exists( 'moments_qodef_configure_visual_composer_frontend_editor' ) ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function moments_qodef_configure_visual_composer_frontend_editor() {
	...
	add_action( 'vc_after_init', 'moments_qodef_configure_visual_composer_frontend_editor' );
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Qodef_Service_Tables extends WPBakeryShortCodesContainer {
	}
}
...
/*** Row ***/
if ( ! function_exists( 'moments_qodef_vc_row_map' ) ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function moments_qodef_vc_row_map() {
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__( 'Row Type', 'moments' ),
			'param_name' => 'row_type',
			'value'      => array(
				'Row'      => 'row',
				'Parallax' => 'parallax'
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__( 'Content Width', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__( 'Header Style', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__( 'Anchor ID', 'moments' ),
			'param_name'  => 'anchor',
			'value'       => '',
			'description' => esc_html__( 'For example "home"', 'moments' )
		) );
		vc_add_param( 'vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__( 'Content Aligment', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__( 'Video Background', 'moments' ),
			'value'       => array(
				'No'  => '',
				'Yes' => 'show_video'
			),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__( 'Video Overlay', 'moments' ),
			'value'       => array(
				'No'  => '',
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__( 'Video Overlay Image (pattern)', 'moments' ),
			'value'       => '',
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__( 'Video Background (webm) File URL', 'moments' ),
			'value'       => '',
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__( 'Video Background (mp4) file URL', 'moments' ),
			'value'       => '',
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__( 'Video Background (ogv) file URL', 'moments' ),
			'value'       => '',
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__( 'Video Preview Image', 'moments' ),
			'value'       => '',
		...
		vc_add_param( "vc_row", array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__( 'Full Screen Height', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__( 'Vertically Align Content In Middle', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__( 'Section Height', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__( 'Parallax Background image', 'moments' ),
			'value'       => '',
			'param_name'  => 'parallax_background_image',
			'description' => esc_html__( 'Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'moments' ),
			'dependency'  => Array( 'element' => 'row_type', 'value' => array( 'parallax' ) )
		) );
		...
		vc_add_param( 'vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__( 'Parallax speed', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'dropdown',
			'heading'     => esc_html__( 'CSS Animation', 'moments' ),
		...
		vc_add_param( 'vc_row', array(
			'type'        => 'textfield',
			'heading'     => esc_html__( 'Transition delay (ms)', 'moments' ),
	...
	add_action( 'vc_after_init', 'moments_qodef_vc_row_map' );
}
