...
class HeaderCentered extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = moments_qodef_filter_px(moments_qodef_options()->getOptionValue('menu_area_height_header_centered'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = moments_qodef_options()->getOptionValue('menu_area_in_grid_header_centered') == 'yes' ? true : false;

        $parameters = apply_filters('moments_qodef_header_centered_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'qodef_menu_area_background_color_header_centered_meta', true) !== ''){
            $menuAreaTransparent = get_post_meta($id, 'qodef_menu_area_background_color_header_centered_meta', true) !== '' &&
                get_post_meta($id, 'qodef_menu_area_background_transparency_header_centered_meta', true) !== '1';
        } elseif(moments_qodef_options()->getOptionValue('menu_area_background_color_header_centered') == '') {
            $menuAreaTransparent = moments_qodef_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
                moments_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') !== '1';
        } else {
            $menuAreaTransparent = moments_qodef_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
                moments_qodef_options()->getOptionValue('menu_area_background_transparency_header_centered') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'qodef_menu_area_background_color_header_centered_meta', true) !== ''){
            $menuAreaTransparent = get_post_meta($id, 'qodef_menu_area_background_color_header_centered_meta', true) !== '' &&
                get_post_meta($id, 'qodef_menu_area_background_transparency_header_centered_meta', true) === '0';
        } elseif(moments_qodef_options()->getOptionValue('menu_area_background_color_header_centered') == '') {
            $menuAreaTransparent = moments_qodef_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
                moments_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') === '0';
        } else {
            $menuAreaTransparent = moments_qodef_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
                moments_qodef_options()->getOptionValue('menu_area_background_transparency_header_centered') === '0';
        }
