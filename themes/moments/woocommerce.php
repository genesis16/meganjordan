...
moments_qodef_get_title();
get_template_part('slider');

$full_width = false;

if ( moments_qodef_options()->getOptionValue('qodef_woo_products_list_full_width') == 'yes' && !is_singular('product') ) {
	$full_width = true;
}

if ( $full_width ) { ?>
	<div class="qodef-full-width" <?php moments_qodef_inline_style($background_color); ?>>
<?php } else { ?>
	<div class="qodef-container" <?php moments_qodef_inline_style($background_color); ?>>
<?php }
		if ( $full_width ) { ?>
			<div class="qodef-full-width-inner" <?php moments_qodef_inline_style($content_style); ?>>
		<?php } else { ?>
			<div class="qodef-container-inner clearfix" <?php moments_qodef_inline_style($content_style); ?>>
		<?php }
			...
			if ( ! is_singular('product') ) {
				...
				switch( $sidebar ) {
						...
						<div class="qodef-two-columns-66-33 grid2 qodef-woocommerce-with-sidebar clearfix">
							<div class="qodef-column1">
								<div class="qodef-column-inner">
									<?php moments_qodef_woocommerce_content(); ?>
								</div>
							</div>
					...
					<?php
						break;
					default:
						moments_qodef_woocommerce_content();
				}
