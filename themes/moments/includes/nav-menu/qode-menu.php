...
add_filter( 'wp_setup_nav_menu_item', 'moments_qodef_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'moments_qodef_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'moments_qodef_edit_walker', 10, 2 );


function moments_qodef_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function moments_qodef_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
		
	$check = array('anchor', 'nolink', 'hide', 'type_menu', 'icon', 'icon_pack', 'sidebar', 'wide_position', 'featured_icon');
 ...
 * @return      void
*/
function moments_qodef_edit_walker($walker,$menu_id) {

	return 'MomentsQodef_Walker_Nav_Menu_Edit_Custom';
