 ...
 */
if ( ! class_exists( 'MomentsQodefStickyNavigationWalker' ) ) {
	class MomentsQodefStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $item->hide == "" ) {
				...
				if ( $item->featured_icon !== "" && $item->featured_icon == "fa-circle" ) {
