...
<li <?php wc_product_class( '', $product ); ?>>
    <div class="qodef-product-image-holder">
		 ...
		 * @hooked moments_qodef_get_woocommerce_out_of_stock - 10 - ADDED
		 * @hooked woocommerce_template_loop_product_thumbnail - 10
		 * @hooked woocommerce_template_loop_product_link_close - 20 - ADDED
		 */
		do_action( 'woocommerce_before_shop_loop_item_title' );
		?>
        <div class="qodef-product-button-holder">
			<?php do_action( 'moments_qodef_woocommerce_loop_add_to_cart' ); ?>
        </div>
    </div>
	<?php
	/**
	 ...
	 *
	 * @hooked woocommerce_template_loop_product_link_open - 5 - ADDED
